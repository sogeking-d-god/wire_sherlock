...
#define ALL_METRICS ((metric_index_e[]){METRIC_PACKET_COUNT, METRIC_BYTE_COUNT, METRIC_SYN_FLAG_COUNT, METRIC_FIN_FLAG_COUNT, METRIC_RST_FLAG_COUNT, METRIC_ACK_FLAG_COUNT, METRIC_PSH_FLAG_COUNT})
