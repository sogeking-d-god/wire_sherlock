...
typedef enum
{
    ...
    METRIC_ACK_FLAG_COUNT = 5,
    METRIC_PSH_FLAG_COUNT = 6,
    METRIC_RETRANSMIT_COUNT = 7,
    METRICS_COUNT
} metric_index_e;

#define ALL_METRICS ((metric_index_e[]){METRIC_PACKET_COUNT, METRIC_BYTE_COUNT, METRIC_SYN_FLAG_COUNT, METRIC_FIN_FLAG_COUNT, METRIC_RST_FLAG_COUNT, METRIC_ACK_FLAG_COUNT, METRIC_PSH_FLAG_COUNT, METRIC_RETRANSMIT_COUNT})
...
typedef enum
{
    ...
    BIN_MANAGER_PACKET_TIMESTAMP_OUT_OF_RANGE_WARNING = 1
}bin_manager_ret_e;
