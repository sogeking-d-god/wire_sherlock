...
l3_ret_data_t handle_ipv6_protocol(const uint8_t *data, uint32_t len_left_recorded, uint32_t len_left_on_wire)
{
    ...
    else
    {
        ...
        else
        {
            ...
            ip_tree_insert(ipv6_tree_g, ret_struct.ip_info.src_ip.v6, len_left_on_wire);
            ip_tree_insert(ipv6_tree_g, ret_struct.ip_info.dst_ip.v6, len_left_on_wire);
